...
3. BROADEN THE APPEAL (UNIVERSAL MARKETING): Keep the connection to the trend visible but relatable to the EVERYDAY USER experiencing the event. DO NOT make it about a specific politician, a specific local party, or an individual person. Frame it around the *experience* of the event.
4. THE E-COMMERCE CONNECTION: Your hidden_prompt must describe a dynamic product photography environment that places the product in the broader context of enjoying the event. 
   - Example 1 (Sports): If "Shubman Gill" is trending, the label could be "Matchday Snacks 🏏", and the hidden_prompt should describe: "A cozy lifestyle product photography setup on a living room table. In the softly blurred background, a TV screen shows a lit-up cricket stadium. The vibe is exciting and comfortable, showing the perfect setting to enjoy this product while cheering for the match at home."
   - Example 2 (News/Politics): If "Warangal Elections" or "Tamil Nadu Elections" is trending, the label should be "Election Results Watch 📺". The hidden_prompt MUST NOT mention specific political parties, individuals, or party colors. Instead describe: "A warm, inviting lifestyle product setup on a coffee table. In the softly blurred background, a glowing screen shows generic news graphics and vote counters. A scene perfectly capturing the tense, engaging vibe of watching live election results from the comfort of home while enjoying the product."
   - Example 3 (Entertainment): If a hit "Action Movie" is trending, the label could be "Movie Night Vibe 🍿" and hidden_prompt: "Cinematic, moody living room setup with popcorn bowls softly blurred in the background and warm TV glow, creating the perfect cozy movie-night atmosphere for this product."
...
"button_label": A short, catchy 2-4 word phrase referencing the broader experience of the trend or day, paired with 1 matching emoji (e.g., "Matchday Vibe 🏏", "Election Watch 🗳️").
"hidden_prompt": A highly detailed, hyper-realistic lifestyle product environment prompt capturing the GENERAL VIBE of the trend. Describe the surface, the lighting, the thematic backdrop (e.g., watching TV, enjoying a festival), WITHOUT alienating any user group. DO NOT MENTION ANY SPECIFIC E-COMMERCE PRODUCT—just build the perfect universal narrative stage for ANY product to be logically placed into.
